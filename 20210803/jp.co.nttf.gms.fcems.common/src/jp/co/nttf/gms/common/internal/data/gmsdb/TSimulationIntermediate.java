...
public final class TSimulationIntermediate {
    ...
    /** 双方向AC/DCの充電時電力変換効率 */
    private Double k_acdc_c = null;

    /** 双方向AC/DCの放電時電力変換効率 */
    private Double k_acdc_d = null;

    /** MPPTユニットの電力変換効率 */
    private Double k_dcdc = null;
    ...
    /**
     * 双方向AC/DCの充電時電力変換効率を取得するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @return 双方向AC/DCの充電時電力変換効率
     */
    public Double getKAcdcC() {
        return k_acdc_c;
    }

    /**
     * 双方向AC/DCの充電時電力変換効率を設定するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @param k_acdc_c 双方向AC/DCの充電時電力変換効率
     */
    public void setKAcdcC(Double k_acdc_c) {
        this.k_acdc_c = k_acdc_c;
    }

    /**
     * 双方向AC/DCの放電時電力変換効率を取得するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @return 双方向AC/DCの放電時電力変換効率
     */
    public Double getKAcdcD() {
        return k_acdc_d;
    }

    /**
     * 双方向AC/DCの放電時電力変換効率を設定するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @param k_acdc_d 双方向AC/DCの放電時電力変換効率
     */
    public void setKAcdcD(Double k_acdc_d) {
        this.k_acdc_d = k_acdc_d;
    }

    /**
     * MPPTユニットの電力変換効率を取得するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @return MPPTユニットの電力変換効率
     */
    public Double getKDcdc() {
        return k_dcdc;
    }

    /**
     * MPPTユニットの電力変換効率を設定するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @param k_dcdc MPPTユニットの電力変換効率
     */
    public void setKDcdc(Double k_dcdc) {
        this.k_dcdc = k_dcdc;
    }
}
