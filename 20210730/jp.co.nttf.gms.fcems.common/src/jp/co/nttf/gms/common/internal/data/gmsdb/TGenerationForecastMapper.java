/*
 * TGenerationForecastMapper.java
...
/**
 * TGenerationForecastクラスのMapperインタフェース. <br>
 * <b>【注意】</b> 特になし.
 *
 * @author sekiya
 */
public interface TGenerationForecastMapper {
     ...
     * @return 発電予測
     */
    List<TGenerationForecast> selectAll();
     ...
     * @return 取得結果
     */
    TGenerationForecast getDataWithForecastTime(@Param("d_g_location_id") int d_g_location_id,
     ...
     * @return 取得結果
     */
    List<TGenerationForecast> getDataWithCalcTime(@Param("d_g_location_id") int d_g_location_id,
