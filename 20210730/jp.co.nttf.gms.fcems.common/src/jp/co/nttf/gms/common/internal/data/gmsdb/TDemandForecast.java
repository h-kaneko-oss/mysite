 ...
 * @author sekiya
 */
public final class TDemandForecast {
    ...
    /** 需要電力(予測) */
    private Double demand_forecast_value = null;

    /**
     * コンストラクタ. <br>
     * <b>【注意】</b> 特になし.
     */
    public TDemandForecast() {
    }
    ...
    /**
     * 需要電力(予測)を取得するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @return 需要電力(予測)
     */
    public Double getDemandForecastValue() {
        return demand_forecast_value;
    }

    /**
     * 需要電力(予測)を設定するメソッド. <br>
     * <b>【注意】</b> 特になし.
     *
     * @param demand_forecast_value 需要電力(予測)
     */
    public void setDemandForecastValue(Double demand_forecast_value) {
        this.demand_forecast_value = demand_forecast_value;
    }
}
